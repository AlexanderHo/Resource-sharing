...
<html>
    <head>
        ...
        <body style="background: -webkit-linear-gradient(left, #44703d, #b1cb88  )">
            <nav class="navbar navbar-light bg-light p-3" style="background: -webkit-linear-gradient(left, #44703d, #b1cb88  )" >
        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="background: -webkit-linear-gradient(left, #44703d,#44703d )" >
                    <form action="MainController" method="POST">
