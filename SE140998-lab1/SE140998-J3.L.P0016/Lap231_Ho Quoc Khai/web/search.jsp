<%-- 
    Document   : search.jsp
    Created on : May 30, 2021, 6:40:22 AM
    Author     : PC
--%>
...
<html>
    ...
    <body style="background: -webkit-linear-gradient(left, #44703d, #b1cb88  )
">
        <nav class="navbar navbar-light " style="background: -webkit-linear-gradient(left, #44703d, #b1cb88  );">
            ...
            <div class="col-12 col-md-4 col-lg-6">
                <form class="form-group" action="MainController" method="POST">
                    <div class="input-group bg-light">
                        <input type="text" name="name" class="form-control" placeholder="Enter equipment's name" aria-label="Recipient's username" aria-describedby="basic-addon2"<br/>
                        ...
                        <input type="text" name="usingDate" class="form-control" placeholder="Enter number using date" aria-label="Recipient's username" aria-describedby="basic-addon2"><br/>
            ...
            <div class="col-12 col-md-5 col-lg-4 d-flex align-items-center justify-content-md-end mt-3 mt-md-0">
                <form action="MainController" method="POST">
                    <div class="dropdown">
                            ...
                            <li><a class="bg-light" href="#"><button name="btnAction" class="btn-secondary" type="submit" value="Logout">Logout</button></a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="background: -webkit-linear-gradient(left, #2e5311, #2e5311 )">
                    <form action="MainController" method="POST">
        ...
        <footer class="bg-light text-center text-lg-start fixed-bottom col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4" style="background: -webkit-linear-gradient(left, #44703d, #b1cb88  )">
            <c:if test="${testNull}">
                <form action="MainController" method="POST">
